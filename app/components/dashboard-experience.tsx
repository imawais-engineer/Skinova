      ...
      <Panel className="gradient-border !p-4 sm:!p-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <h2 className="mt-2 text-lg font-semibold text-white sm:text-xl lg:text-2xl">
              Selfie to action plan in under three minutes
            </h2>
          ...
          <Link
            href="/results"
            className="inline-flex h-10 shrink-0 items-center justify-center self-start rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-semibold text-white transition hover:bg-white/10 sm:self-auto"
          >
            View results
        ...
        <div className="mt-3 grid grid-cols-2 gap-2.5 lg:grid-cols-4">
          {careTimeline.map((step, index) => (
            <div key={step.label} className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5 sm:p-3">
              ...
              <p className="mt-0.5 text-xs leading-5 text-slate-400">{step.value}</p>
            </div>
          ))}
        </div>
      </Panel>
      ...
      <Panel className="!p-4 sm:!p-5">
        {analysis ? (
          <>
            ...
            <Link
              href="/routine"
              className="mt-4 inline-flex h-10 w-full items-center justify-center rounded-xl bg-cyan-300 px-4 text-sm font-semibold text-slate-950 transition hover:bg-cyan-200 sm:w-auto"
            >
              Open routine
            </Link>
          </>
