[Skip to content](https://docs.perfectcorp.com/reference/ai_face_analyzer#content)
...
- [View as Markdown\\
\\
Open this page as Markdown](https://docs.perfectcorp.com/reference/ai_face_analyzer.md)
- [Open in ChatGPT\\
\\
Get insights from ChatGPT](https://chat.openai.com/?q=Read+https%3A%2F%2Fdocs.perfectcorp.com%2Freference%2Fai_face_analyzer.md+and+answer+questions+based+on+the+content.)
- [Open in Claude\\
\\
Get insights from Claude](https://claude.ai/new?q=Read+https%3A%2F%2Fdocs.perfectcorp.com%2Freference%2Fai_face_analyzer.md+and+answer+questions+based+on+the+content.)
- Connect to Cursor
...
3. **Run an AI Face Attributes & Ratio Analyzer task**
    ...
    Once the upload is complete, you can select multiple face attributes to analyze using your file ID. Please refer to the **[Inputs & Outputs](https://docs.perfectcorp.com/reference/ai_face_analyzer#section/overview/Inputs-and-Outputs)**.
...
4. **Polling to check the status of a task until it succeed or error**
    ...
    This _**task\_id**_ is used to monitor the task's status through polling GET 'task/face-attr-analysis' to retrieve the current engine status. Until the engine completes the task, the status will remain 'running', and no units will be consumed during this stage.
...
| :-- | :-- | :-- | :-- |
| `faceDetectionMode` | `string` | Detection flow to use (see [Detection Modes](https://docs.perfectcorp.com/reference/ai_face_analyzer#section/Detection-Modes) below). | `"skincare"` |
...
| `qualityOverrides` | `object` | Configure detailed parameters for camera quality verification. | See [Camera Kit Quality Configuration](https://docs.perfectcorp.com/reference/ai_face_analyzer#section/Camera-Kit-Quality-Configuration) |
...
[ai\_face\_analyzer.json](https://docs.perfectcorp.com/_bundle/reference/ai_face_analyzer.json?download)

[ai\_face\_analyzer.yaml](https://docs.perfectcorp.com/_bundle/reference/ai_face_analyzer.yaml?download)
...
## [link to V1.0](https://docs.perfectcorp.com/reference/ai_face_analyzer/v1.0) V1.0
...
- [View as Markdown\\
\\
Open this page as Markdown](https://docs.perfectcorp.com/reference/ai_face_analyzer/v1.0.md)
- [Open in ChatGPT\\
\\
Get insights from ChatGPT](https://chat.openai.com/?q=Read+https%3A%2F%2Fdocs.perfectcorp.com%2Freference%2Fai_face_analyzer%2Fv1.0.md+and+answer+questions+based+on+the+content.)
- [Open in Claude\\
\\
Get insights from Claude](https://claude.ai/new?q=Read+https%3A%2F%2Fdocs.perfectcorp.com%2Freference%2Fai_face_analyzer%2Fv1.0.md+and+answer+questions+based+on+the+content.)
- Connect to Cursor
...
/s2s/v2.0/task/face-attr-analysis/{task\_id}
